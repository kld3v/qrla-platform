            ...
            <v-col
                ...
                <div class="d-flex justify-center align-center h-100">
                    <div class="mt-xl-0 mt-5 auth-card">
                        <LogoIcon />
                        <h2 class="text-h3 my-3">Register</h2>
                        ...
                        <form
                            ...
                            <!-- Hidden Token Field -->
                            <input type="hidden" v-if="form.token" name="token" v-model="form.token" />
                    ...
                    <v-row class="justify-center z-index-2">
                        <v-col
                            ...
                            <p class="text-h6 text-white opacity-80 font-weight-regular mt-4 lh-md">
                                Connecting you to your customers via the physical-digital space.
                            </p>
                        </v-col>
                    </v-row>
                </div>
