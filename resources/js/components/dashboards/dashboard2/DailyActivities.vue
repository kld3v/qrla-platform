	...
	<v-card elevation="10">
		<v-card-item>
			...
			<div class="daily-activities mt-10 px-3">
				<div
					v-for="list in DailyActivitiesData"
					:key="list.title">
					<v-row class="d-flex mb-1">
						<v-col
							...
							md="auto"
							sm="auto"
							class="px-0 pt-0 pb-0 d-flex align-start">
							<p class="text-body-1 text-muted text-no-wrap">{{ list.title }}</p>
						</v-col>
						<v-col
							cols="1"
							sm="1"
							class="px-0 text-center pt-0 pb-0 mt-1">
							<Icon
							...
							<div
								v-if="list.line"
								class="line mx-auto bg-borderColor"></div>
						</v-col>
						<v-col
							cols="7"
							sm="8"
							...
							<h6
								v-if="list.boldtext"
								class="text-body-1 text-textPrimary">
								{{ list.subtitle }}
							</h6>
							<p
								v-else
								class="text-body-1 text-muted">
								{{ list.subtitle }}
							</p>
							<div class="mt-n1">
								<Link
