			...
			<v-row class="d-flex flex-cols gap-3">
				...
				<v-col cols="12">
					...
					<div v-if="discount == 'percent'">
						<v-row>
							<v-col cols="12">
								<v-label class="font-weight-medium mb-2">Set Discount Percentage <span class="text-error ms-1">*</span></v-label>
						...
						<v-row>
							<v-col
								...
								<VTextField
									...
									variant="outlined"
									hide-details></VTextField>
								<p class="textSecondary text-12 mt-1">Set the discounted product price. The product will be reduced at the determined fixed price</p>
							</v-col>
							<v-col
								cols="12"
								md="6"
